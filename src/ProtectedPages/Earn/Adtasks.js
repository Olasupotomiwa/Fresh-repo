  ...
  return (
    ...
    <Flex justifyContent="space-between" alignItems="flex-start" width={{base: '100%', md: '100%', lg: '80%'}}>
      ...
      <Box display='flex'>
       ...
       <Box>
      <Heading color='white' fontFamily='clash grotesk' fontWeight='500' textAlign='left' fontSize={{base: '14px', md: '20px'}} lineHeight={1.5}>Post adverts on instagram || Earn $10 per advert post</Heading>
