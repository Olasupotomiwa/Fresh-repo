import { Box , FormControl, FormLabel, Input, InputRightElement, InputGroup, Button} from "@chakra-ui/react";
      ...
      <FormControl fontFamily="clash grotesk" my={5}>
                ...
                <InputGroup>
                  ...
                  <InputRightElement width="4.5rem">
                    ...
                    >
                      {showPassword1 ? <ViewOffIcon color='#808080' /> : <ViewIcon color='#808080' />}
                    </Button>
                  </InputRightElement>
                </InputGroup>
